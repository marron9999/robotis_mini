...
//	public static final byte[] _DYNAMIXELChannel = {16, 1};	// DYNAMIXELとの通信ポート選択	RW	0
	...
	public static final int[] _ButtonStatus = {26, 1};		// スタートボタンの状態	R	0
	public static final int[] _MotionPlayPage = {66, 2};	// Motion Play ページ番号	RW	0
	public static final int[] _MotionPlayStatus = {68, 1};	// Motion Play ステータス	R	-
	public static final int[] _TimerValue_128ms = {73, 1};	// 128ms タイマカウンタ	RW	0
	public static final int[] _TimerValue_1ms = {74, 2};	// 1ms  タイマカウンタ	RW	0
	public static final int[] _RandomNumber = {77, 1};		// 乱数値の生成	RW	-
	public static final int[] _GreenLED = {79, 1};			// 緑LEDのステータス	RW	0
	public static final int[] _MotionLED = {82, 1};		// Motion LEDのステータス	RW	0
	// 360	2	Port 1 IR Sensor Value	ポート1の赤外線センサ値	R	-
	// 362	2	Port 2 IR Sensor Value	ポート2の赤外線センサ値	R	-
	// 364	2	Port 3 IR Sensor Value	ポート3の赤外線センサ値	R	-
	// 366	2	Port 4 IR Sensor Value	ポート4の赤外線センサ値	R	-
	public static final int[] _Port1DMSSensorValue = {368, 2};	// ポート1の距離センサ値	R	-
	public static final int[] _Port2DMSSensorValue = {370, 2};	// ポート2の距離センサ値	R	-
	public static final int[] _Port3DMSSensorValue = {372, 2};	// ポート3の距離センサ値	R	-
	public static final int[] _Port4DMSSensorValue = {374, 2};	// ポート4の距離センサ値	R	-
	...
	public static final int[] _Port2UserDeviceValue = {386, 2};	// ポート2のユーザーデバイス値	RW	0
	public static final int[] _Port3UserDeviceValue = {388, 2};	// ポート3のユーザーデバイス値	RW	0
